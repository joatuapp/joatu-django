# Generated by Django 2.0.3 on 2018-06-18 05:52
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('projects', '0038_auto_20180503_2129'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='project',
            name='category',
            field=models.CharField(choices=[('Cul', 'Culture and Recreation'), ('Edu', 'Education'), ('Hea', 'Health'), ('Soc', 'Social Services'), ('Env', 'Environment'), ('Oth', 'Other')], max_length=3),
        ),
        migrations.AlterField(
            model_name='project',
            name='sub_category',
